...
from speechbrain.lobes.models.transformer.TransformerMamba import (
    TransformerInterfaceMambaAttentionEncoderDecoder,
    get_lookahead_mask,
...
class TransformerASR(TransformerInterfaceMambaAttentionEncoderDecoder):
    def __init__(
        self,
        tgt_vocab,
        input_size,
    ...
    def decode(self, tgt, encoder_out, enc_len=None):
        ...
        prediction, multihead_attns = self.decoder(
            tgt,
            encoder_out,
            tgt_mask=tgt_mask,
            memory_key_padding_mask=src_key_padding_mask,
